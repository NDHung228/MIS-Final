                        ...
                        <div className="mb-6">
                            ...
                            <div className="col-span-4">
                                ...
                                <div className='border-gray h-fit' style={{ borderWidth: '1px', borderTopWidth: '0' }}>
                                    ...
                                    <div className="grid grid-cols-8 border-t border-stroke py-6 px-4 dark:border-strokedark justify-center">
                                        <div className="col-span-3 flex items-center justify-center">
                                            <ListBox people={[
                                                { name: 'Eu 38' },
                                                { name: 'Eu 39' },
