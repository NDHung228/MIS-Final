    ...
    <>
      ...
      <div>
        <div className="bg-white grid grid-cols-11 border-t border-stroke py-4.5 px-4 dark:border-strokedark">
          ...
          <div className="col-span-3 hidden items-center sm:flex">
            <p className="text-sm text-black dark:text-white">
              Nike Air Force 1 - New (1), Nike Court Vision Low - 2hand (1)</p>
          </div>
          <div className="col-span-2 flex items-center justify-center">
            <p className="text-sm text-black dark:text-white">300</p>
          </div>
          <div className="col-span-1 flex items-center justify-center">
            <p className="inline-flex rounded-full bg-meta-5 bg-opacity-10 py-1 px-3 text-sm font-medium text-primary">
              Delivering
            </p>
          </div>
          <div className="col-span-1 flex items-center justify-center">
          ...
          <div className="col-span-1 flex items-center justify-center">
            ...
            } content={<OrderDetail delivery={true}/>} right='right-45' />
          </div>
