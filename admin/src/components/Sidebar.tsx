  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <div>
            <p className='text-white text-4xl font-bold text-center'>Shoes Store</p>
          </div>
        </NavLink>
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/manage' ||
              ...
              <li>
                <NavLink
                  to="/coupon"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('coupon') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <img className='h-5 w-5' src="/discount.png" alt="" />
                  <span>Coupon</span>
                </NavLink>
              </li>
              ...
              <li>
                <NavLink
                  to="/delivery"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('delivery') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <img className='h-5 w-5' src="/delivery.png" alt="" />
                  <span>Delivery</span>
                </NavLink>
              </li>
              ...
              <li>
                ...
                >
                  <img className='h-5 w-5' src="/user.png" alt="" />
                  <span>Users</span>
                </NavLink>
              </li>
