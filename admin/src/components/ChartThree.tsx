...
const ChartThree: React.FC = () => {
  ...
  return (
    <div className="h-fit col-span-12 rounded-sm border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-4">
      ...
      <div className="-mx-8 flex flex-wrap items-center justify-center gap-y-3 mt-5">
