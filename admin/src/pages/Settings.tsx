                ...
                <form action="#">
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <input
                        ...
                        name="phoneNumber"
                        id="phoneNumber"
                        placeholder="0393437865"
                        defaultValue="0393437865"
                      />
                    </div>
                  </div>
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        defaultValue="nnhuy45@gmail.com"
                      />
                    </div>
                  </div>
                  ...
                  <div className="mb-5.5">
                    ...
                    <input
                      ...
                      name="Username"
                      id="Username"
                      placeholder="nguyenhuy24"
                      defaultValue="nnhuy45"
                    />
                  </div>
                ...
                <form action="#">
                  <div className="mb-4 flex items-center gap-3">
                    <div className="h-14 w-14 rounded-full">
                      <img src='/avatar-user-1.jpg' alt="User" className='rounded-full h-14 w-14'/>
                    </div>
                    <div>
